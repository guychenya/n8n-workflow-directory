...
export const EnhancedWorkflowModal: React.FC<EnhancedWorkflowModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-7xl w-full mx-4 max-h-[98vh] overflow-hidden">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-6 overflow-y-auto max-h-[calc(98vh-240px)]">
          {loading && (
